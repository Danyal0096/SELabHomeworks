# Software Engineering Lab — Homeworks

This repository contains the source code and documentation for the Software Engineering Lab course. Each experiment is maintained in its own directory.
...
| 05 | Docker Fundamentals | Dockerfiles, Docker Compose, networking, and port forwarding | Not started |
...
Additional experiment directories will be added as those assignments are undertaken.

## Tools and technologies

Experiment 1 uses Git, GitHub, HTML, CSS, JavaScript, GitHub Actions, and GitHub Pages. Subsequent experiments cover Java and testing tools, OpenCode, and Docker; their dependencies and instructions will be documented in their own directories.
